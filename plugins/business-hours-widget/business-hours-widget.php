 ...
 *
 * This is a widget for the inhabitent theme to create a widget to set and display business hours.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Inhabitent Business Hours Widget
 * @author    Cam <cameron.jr.thorn@gmail.com>
 * @license   GPL-2.0+
 ...
 * Description:       Allows us to set the business hours in the sidebar
 * Version:           1.0.0
 * Author:            Cam
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Add store business hours'
			)
		);
